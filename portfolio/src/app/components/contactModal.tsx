  ...
  return (
    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-50">
      <div className="z-50 bg-primary p-6 shadow-lg max-w-xl w-full mx-auto rounded-lg">
        ...
        <button className="w-full pr-2 text-right text-cardDarkGrey text-p font-light hover:text-bluePrimary" onClick={props.onClose}>
          X
        </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          <label className="mb-2 text-cardDarkGrey text-sm font-light">Email</label>
          <input
            type="email"
          ...
          <label className="mb-2 text-cardDarkGrey text-sm font-light">Message</label>
          <textarea
