...
export default function AllProjectsLayout(props: AllProjectsProps) {
  ...
  return (
    <div className="w-full pb-10">
      <h2 className="text-h3 mx-5 font-mono font-light md:text-h2 pt-7 pb-5 text-blackPrimary">
        {props.title}
      </h2>
      <h4 className="mx-5 justify-left font-mono text-b text-blackPrimary">
        {props.description}
      </h4>
      <hr className="mx-5"></hr>
      <div className="flex flex-wrap items-center justify-between mx-5 mt-5 font-sans">
      ...
      <div className="m-auto w-full px-5 pt-10 gap-y-10 gap-x-5 grid grid-cols-1 md:grid-cols-12">
