  ...
  return (
    <div className="w-full h-full p-10">
      ...
      <div className="flex gap-x-4 mt-5 mx-5">
        <img
          className="w-2/3 border border-greyPrimary object-cover"
          src={sectionDetails.wireframes}
        ></img>
        <div className="w-1/3 flex flex-wrap gap-y-4">
          <img
            className="w-full border border-greyPrimary object-cover"
      ...
      <img
        className="w-full mt-5 mx-5 border border-greyPrimary object-cover"
