...
export default function Pen(props: PenProps) {
  ...
  return (
    <div>
      <h4 className="ml-36 font-mono text-h4 text-cardDarkGrey transform rotate-15">
        {message}
      </h4>
      <div className="relative flex">
        <img
          src={props.canvasImage}
          className="my-2 overflow-hidden w-full h-96 object-cover z-0 mx-10 mt-6 pt-5"
          alt="Canvas Image"
        />
        {isDrawing && (
        ...
        <img
          className="ml-20 scale-95 absolute cursor-pointer z-20 bg-transparent hover:scale-110 transition-transform"
          src="pen.svg"
          alt="pen"
